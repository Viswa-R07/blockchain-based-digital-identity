...
echo "Package created at ${PKG_FILE}"
ls -lh "${PKG_FILE}"

echo "========================================================="
echo " Step 2: Installing ${CC_NAME}_${CC_VERSION} on all 4 Orgs"
echo "========================================================="
...
echo ">>> Chaincode ${CC_NAME}_${CC_VERSION} (Sequence ${CC_SEQUENCE}) successfully upgraded and committed on ${CHANNEL_NAME}!"
